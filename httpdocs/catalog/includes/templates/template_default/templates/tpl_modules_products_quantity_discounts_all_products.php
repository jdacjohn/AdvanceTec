...
<?php } else { ?>
  <table border="1" cellspacing="5" cellpadding="5" style="width:400px ;">
    <tr class="tableOdd">
      <td class="headstrong" colspan="<?php echo $columnCount+1; ?>" align="center">
<?php 
...
?>
    ...
    <tr>
      <td align="center" style="width:300px;"> <?php echo $show_qty . '<br />' . $currencies->display_price($show_price, zen_get_tax_rate($products_tax_class_id)); ?></td>

<?php 
  foreach($quantityDiscounts as $key=>$quantityDiscount) {
?>
<td align="center" style="width:300px;"><?php echo $quantityDiscount['show_qty'] . '<br />' . $currencies->display_price($quantityDiscount['discounted_price'], zen_get_tax_rate($products_tax_class_id)); ?></td>
<?php
    $disc_cnt++;
...
?>
    <td align="center" colspan="<?php echo ($columnCount+1 - $disc_cnt)+1; ?>"> * Discounts may vary based on options above  </td>
<?php } ?>
    </tr>
<?php
