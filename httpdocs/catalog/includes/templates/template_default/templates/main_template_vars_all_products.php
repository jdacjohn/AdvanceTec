 ...
 */
  ...
  $sql = "select count(*) as total
          ...
          and      p.products_id = '" . $products_all->fields['products_id'] . "'
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $tpl_page_body = '/tpl_product_info_display_all_products.php';

    $sql = "update " . TABLE_PRODUCTS_DESCRIPTION . "
            set        products_viewed = products_viewed+1
            where      products_id = '" . $products_all->fields['products_id']  . "'
    ...
    $manufacturers_name= zen_get_products_manufacturers_name($products_all->fields['products_id'] );
...
// if review must be approved or disabled do not show review
    ...
    $reviews_query = "select count(*) as count from " . TABLE_REVIEWS . " r, "
                       ...
                       where r.products_id = '" . $products_all->fields['products_id']  . "'
  ...
  $products_id_current = $products_all->fields['products_id'] ;
