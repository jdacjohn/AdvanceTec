...
<h2 id="checkoutShippingHeadingAddress"><?php echo "Shipping Information:"; ?></h2>

<div id="checkoutShipto" class="floatingBox back">
<?php 
$displayAddressEdit = "index.php?main_page=checkout_shipping_address"; 
$editShippingButtonLink = "index.php?main_page=checkout_shipping_address";
?>
...
<div class="floatingBox important forward"><?php echo "Your order will be shipped to the address at the left or you may change the shipping address by clicking the Change Address button."; ?></div>
<br clear="all">
