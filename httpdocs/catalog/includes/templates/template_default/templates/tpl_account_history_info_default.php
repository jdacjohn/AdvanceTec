...
?>
<h4 style="visibility:hidden;"><?php echo HEADING_SHIPPING_METHOD; ?></h4>
<div style="visibility:hidden;"><?php echo $order->info['shipping_method']; ?></div>
...
<h4 style="visibility:hidden;"><?php echo HEADING_PAYMENT_METHOD; ?></h4>
<div style="visibility:hidden;"><?php echo $order->info['payment_method']; ?></div>
</div>
<br class="clearBoth" />
</div>