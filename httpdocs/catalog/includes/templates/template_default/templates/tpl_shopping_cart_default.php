...
<?php
  if ($product['flagShowFixedQuantity']) {
    echo $product['showFixedQuantityAmount'] . '<br /><span class="alert bold">' . $product['flagStockCheck'] . '</span><br /><br />' . $product[''];
  } else {
    echo $product['quantityField'] . '<br /><span class="alert bold">' . $product['flagStockCheck'] . '</span><br /><br />' . $product[''];
  }
?>
       </td>
...
<div class="buttonRow back"><?php echo "<a href='http://advancetec.uppercasedesigngroup.com/catalog/index.php?main_page=products_all'>"; ?><?php echo zen_image_button(BUTTON_IMAGE_CONTINUE_SHOPPING, BUTTON_CONTINUE_SHOPPING_ALT) . '</a>'; ?></div>
<?php
// show update cart button
  if (SHOW_SHOPPING_CART_UPDATE == 2 or SHOW_SHOPPING_CART_UPDATE == 3) {
?>
<div class="buttonRow back" style="margin-top: 2px;margin-right: -5px;"><?php echo zen_image_submit(ICON_IMAGE_UPDATE_TWO, ICON_UPDATE_ALT); ?></div>
<?php
