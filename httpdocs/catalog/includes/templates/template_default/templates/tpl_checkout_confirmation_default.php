...
<h3 id="checkoutConfirmDefaultPayment" style="visibility: hidden;"><?php echo HEADING_PAYMENT_METHOD; ?></h3> 
<h4 id="checkoutConfirmDefaultPaymentTitle" style="visibility: hidden;"><?php echo $GLOBALS[$class]->title; ?></h4>

<?php
  if (is_array($payment_modules->modules)) {
    if ($confirmation = $payment_modules->confirmation()) {
?>
<div class="important" style="visibility: hidden;"><?php echo $confirmation['title']; ?></div>
<?php
    }
?>
<div class="important">
...
?>
<!-- Modified for AdvanceTecSafeDeposit.com 03202013 - jarnold -->
<h3 id="checkoutConfirmDefaultShipment" style="visibility: hidden;"><?php echo HEADING_SHIPPING_METHOD; ?></h3>
<h4 id="checkoutConfirmDefaultShipmentTitle" style="visibility: hidden;"><?php echo $order->info['shipping_method']; ?></h4>
<?php
    }
?>
...
<br class="clearBoth" />
<hr />
<h2 id="checkoutConfirmDefaultHeadingComment">Your total cost, including tax, shipping & handling will be invoiced once your order has shipped.</h4>
<hr />
