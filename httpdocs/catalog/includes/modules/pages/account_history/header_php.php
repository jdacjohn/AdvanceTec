...
//echo "Orders Total = " . $orders_total . "<br />";
if ($orders_total > 0) {
  $history_query_raw = "SELECT o.orders_id, o.date_purchased, o.delivery_name,
                        ...
                        ORDER BY   orders_id DESC, s.orders_status_id";
  ...
  $history = $db->Execute($history_split->sql_query);
	//echo "History size after initial query = " . sizeof($history) . "<br />";
  ...
  while (!$history->EOF) {
	...
	//echo "Account History Size at end of header = " . sizeof($accountHistory) . "<br />";
} else {
