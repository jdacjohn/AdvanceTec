...
define('EMAIL_TEXT', 'You are now registered with AdvanceTec Safe Deposits and have account privileges.' . "\n\n</ul>");
define('EMAIL_CONTACT', 'For help with any of our online services, please call 888.231.0745 or email us: <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS ." </a>\n\n");
define('EMAIL_GV_CLOSURE', "\n" . 'Sincerely,' . "\n\n" . 'Mary Newman' . "\nAdvanceTec Safe Deposit\n\n". '<a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">'.HTTP_SERVER . DIR_WS_CATALOG ."</a>\n\n");
