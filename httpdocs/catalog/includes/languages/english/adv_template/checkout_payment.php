...
define('TEXT_SELECTED_BILLING_DESTINATION', 'Your billing address is shown to the left. You can change the billing address by clicking the <em>Change Address</em> button.');
define('TITLE_BILLING_ADDRESS', 'Billing Information:');
...
define('TABLE_HEADING_COMMENTS', 'Add Purchase Order Number or Any Other Special Instructions About Your Order');
...
define('TITLE_CONTINUE_CHECKOUT_PROCEDURE', '<strong>Continue to Confirm</strong>');
