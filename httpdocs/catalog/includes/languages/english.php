...
// define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>');
  ...
  '<div class="myFooter"> 
  	<div class="myFooterinfo">
  	  		<p> P 210-829-7544 <span class="verticalSlash">&#124;</span> F 210-829-7582 <span class="verticalSlash">&#124;</span> 2554 MacArthur View, San Antonio, Texas 78217 <br/>
  	  		<a href="mailto=info@advancetecsafedeposit.com">info@advancetecsafedeposit.com</a></p>
  	  	</div>
  	<div class="myFootercopy">
  		&copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">AdvanceTec Safe Deposit Services, Inc</a>. All Rights Reserved.
  	</div>
...
// javascript messages
  ...
  define('TEXT_CLICK_TO_ENLARGE', '*Click thumbnail for larger image');
...
// more info in place of buy now
  //define('MORE_INFO_TEXT','Multiple Prices Available for this Product');
  define('MORE_INFO_TEXT','... click more info');  
...
// cart contents
  ...
  define('PRODUCTS_ORDER_QTY_TEXT','&nbsp;<b>Qty: </b>');
...
// discount qty table
  ...
  define('TEXT_HEADER_DISCOUNT_PRICES_ACTUAL_PRICE', 'Quantity Discounts');
...
// create account - login shared
  ...
  define('ENTRY_EMAIL_PREFERENCE','Notifications  and Email Details');
