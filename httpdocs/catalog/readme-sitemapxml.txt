...
Support $_GET parameters:
-------------------------
ping=yes - Pinging Google, Ask.com and Microsoft.
...
or
0 5 * * * wget -q 'http://<your_shop_url>/index.php?main_page=sitemapxml' -O/dev/null
or
0 5 * * * curl -s 'http://<your_shop_url>/index.php?main_page=sitemapxml'
or
0 5 * * * php -f <path_to_shop>/cgi-bin/sitemapxml.php rebuild=yes
